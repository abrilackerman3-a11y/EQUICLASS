...
import IconGraph from "../assets/graph.svg?react";
  ...
  return (
    <div className="w-full h-[100dvh] flex flex-col overflow-hidden bg-[#11111b]">
      ...
      <div className="w-full bg-[#181825] border-b border-[#313244] px-4 py-3 flex items-center justify-between shadow-sm z-30 shrink-0">
        <div>
          <h1 className="text-base font-bold text-[#cdd6f4]">
            <IconGraph className="inline-block w-4 h-4 mx-1 align-middle text-[#cba6f7]" />
            Equiclass
          </h1>
          <p className="text-xs text-[#a6adc8] hidden sm:block">
            Myhill-Nerode paso a paso
          </p>
        </div>
      </div>
      ...
      <div className="flex-1 w-full flex flex-col md:flex-row overflow-hidden">
        <div
          // Borde divisor entre lienzos
          className={`relative border-b md:border-b-0 md:border-r border-[#313244] transition-all duration-700 ease-in-out shrink-0
            w-full md:h-full 
